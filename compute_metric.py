...
parser.add_argument(
    "--pred_path",
    type=str,
    default="results/13-5_dual_image-iwt_lf-id/celeba-hq_custom-aligned_validation/pred",
)
parser.add_argument(
    "--gt_path",
    type=str,
    default="results/13-5_dual_image-iwt_lf-id/celeba-hq_custom-aligned_validation/hr",
)
parser.add_argument(
