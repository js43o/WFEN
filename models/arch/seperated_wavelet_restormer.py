...
class LFRefineBlock(nn.Module):
    def __init__(self, inp_channels, dim, ffn_expansion_factor, bias, LayerNorm_type):
        super(LFRefineBlock, self).__init__()
...
class WaveletRestormer(nn.Module):
    def __init__(
        ...
        self.refine_lf = LFRefineBlock(inp_channels, dim, ffn_expansion_factor, bias, LayerNorm_type)
    ...
    def forward(self, inp_img):
        ...
        refined_hf = self.refinement(out_dec_level1)
