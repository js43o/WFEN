...
# Train WFEN
# ==============
python train.py --gpus 1 --name 5-5_quad-hf-vq --model vqwfen \
    --Gnorm "bn" --lr 0.0002 --beta1 0.9 --scale_factor 8 --load_size 128 \
    --dataroot /vcl2/Jiseung/datasets/ffhq_custom-aligned_filtered --dataset_name blind_ffhq --batch_size 16 --total_epochs 50 \
